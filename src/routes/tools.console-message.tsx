...
export const Route = createFileRoute("/tools/console-message")({
  head: () => ({ meta: [
    ...
    { name: "description", content: "Generate a small JavaScript snippet that prints a hidden message in the browser console." },
  ]}),
  component: Page,
});
...
function Page() {
  ...
  return (
    <div className="mx-auto max-w-3xl">
      <PageHeader eyebrow="Console" title="A message in the browser console" description="A small script you can include on a page you own to greet curious visitors." />
      <GlassCard className="space-y-5 p-6">
        <div className="space-y-2"><label className="text-sm font-medium">Message</label>
        ...
        <p className="text-xs text-muted-foreground">Only use scripts on websites you own or are allowed to edit.</p>
      </GlassCard>
    </div>
  );
}
