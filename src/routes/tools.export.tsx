...
const ROWS = [
  {
    title: "Encoded / decoded text",
    desc: "Use the copy button in any encoder tool to grab the result.",
    to: "/tools/encoder",
  },
  {
    title: "Challenge JSON",
    desc: "Export your composed challenge as a local JSON file.",
    to: "/tools/challenge",
  },
  { title: "QR images", desc: "Download QR codes as PNG or SVG.", to: "/tools/qr-secret" },
  {
    title: "QR trail bundle",
    desc: "Download all QR codes in a trail plus instructions.",
    to: "/tools/qr-trail",
  },
  { title: "Secret note file", desc: "Save an encrypted note as JSON.", to: "/tools/secret-note" },
  {
    title: "Image with hidden message",
    desc: "Save a PNG that carries a hidden message.",
  ...
  {
    title: "Solution path",
    desc: "Save your puzzle-solving steps as TXT.",
  ...
  return (
    <div className="mx-auto max-w-4xl">
      <PageHeader
        eyebrow="Export"
        title="Export centre"
        description="Every Easter result you can save locally, in one place."
      />
