...
export const Route = createFileRoute("/tools/")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Every Easter tool, grouped by category. Search, filter and open.",
      },
...
function ToolsIndex() {
  ...
  return (
    <div className="mx-auto max-w-6xl">
      <PageHeader
        eyebrow="Toolbox"
        title="Every Easter tool."
        description="Search, filter and open. Each one runs locally in your browser."
      />
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            onChange={(e) => {
              ...
              navigate({
                search: (s: Record<string, unknown>) => ({ ...s, q: e.target.value || undefined }),
              });
            }}
