...
function Page() {
  ...
  const exportTxt = () => {
    ...
    a.download = "easter-solution.txt";
    a.click();
  };
  ...
  return (
    <div className="mx-auto max-w-4xl">
      <PageHeader
        ...
        description="Apply transformations one step at a time. Easter doesn't promise automatic solving — it shows your work."
      />
      <GlassCard className="space-y-4 p-6">
        ...
        <div className="flex flex-wrap gap-2">
          <Button onClick={reset} variant="outline" className="border-white/10 bg-white/5">
          ...
          >
            <Download className="mr-2 h-3.5 w-3.5" /> Export path
          </Button>
        </div>
      </GlassCard>
      {path.length > 0 && (
